...
always @ (*) begin
    if (reset) begin
        ...
        m_tmp[0][1] = (s_valid)? m_inp[0][0] : m_inp[0][1];
        m_tmp[0][2] = (s_valid)? m_inp[0][1] : m_inp[0][2];
        m_tmp[0][3] = (s_valid)? m_inp[0][2] : m_inp[0][3];
        m_tmp[0][4] = (s_valid)? m_inp[0][3] : m_inp[0][4];
        m_tmp[0][5] = (s_valid)? m_inp[0][4] : m_inp[0][5];
        m_tmp[0][6] = (s_valid)? m_inp[0][5] : m_inp[0][6];

        m_tmp[1][1] = (s_valid)? m_inp[1][0] : m_inp[1][1];
        m_tmp[1][2] = (s_valid)? m_inp[1][1] : m_inp[1][2];
        m_tmp[1][3] = (s_valid)? m_inp[1][2] : m_inp[1][3];
        m_tmp[1][4] = (s_valid)? m_inp[1][3] : m_inp[1][4];
        m_tmp[1][5] = (s_valid)? m_inp[1][4] : m_inp[1][5];
        m_tmp[1][6] = (s_valid)? m_inp[1][5] : m_inp[1][6];
        
        m_tmp[2][1] = (s_valid)? m_inp[2][0] : m_inp[2][1];
        m_tmp[2][2] = (s_valid)? m_inp[2][1] : m_inp[2][2];
        m_tmp[2][3] = (s_valid)? m_inp[2][2] : m_inp[2][3];
        m_tmp[2][4] = (s_valid)? m_inp[2][3] : m_inp[2][4];
        m_tmp[2][5] = (s_valid)? m_inp[2][4] : m_inp[2][5];
        m_tmp[2][6] = (s_valid)? m_inp[2][5] : m_inp[2][6];
        
        m_tmp[3][1] = (s_valid)? m_inp[3][0] : m_inp[3][1];
        m_tmp[3][2] = (s_valid)? m_inp[3][1] : m_inp[3][2];
        m_tmp[3][3] = (s_valid)? m_inp[3][2] : m_inp[3][3];
        m_tmp[3][4] = (s_valid)? m_inp[3][3] : m_inp[3][4];
        m_tmp[3][5] = (s_valid)? m_inp[3][4] : m_inp[3][5];
        m_tmp[3][6] = (s_valid)? m_inp[3][5] : m_inp[3][6];
        
        m_tmp[4][1] = (s_valid)? m_inp[4][0] : m_inp[4][1];
        m_tmp[4][2] = (s_valid)? m_inp[4][1] : m_inp[4][2];
        m_tmp[4][3] = (s_valid)? m_inp[4][2] : m_inp[4][3];
        m_tmp[4][4] = (s_valid)? m_inp[4][3] : m_inp[4][4];
        m_tmp[4][5] = (s_valid)? m_inp[4][4] : m_inp[4][5];
        m_tmp[4][6] = (s_valid)? m_inp[4][5] : m_inp[4][6];
        
        m_tmp[5][1] = (s_valid)? m_inp[5][0] : m_inp[5][1];
        m_tmp[5][2] = (s_valid)? m_inp[5][1] : m_inp[5][2];
        m_tmp[5][3] = (s_valid)? m_inp[5][2] : m_inp[5][3];
        m_tmp[5][4] = (s_valid)? m_inp[5][3] : m_inp[5][4];
        m_tmp[5][5] = (s_valid)? m_inp[5][4] : m_inp[5][5];
        m_tmp[5][6] = (s_valid)? m_inp[5][5] : m_inp[5][6];
        
        m_tmp[6][1] = (s_valid)? m_inp[6][0] : m_inp[6][1];
        m_tmp[6][2] = (s_valid)? m_inp[6][1] : m_inp[6][2];
        m_tmp[6][3] = (s_valid)? m_inp[6][2] : m_inp[6][3];
        m_tmp[6][4] = (s_valid)? m_inp[6][3] : m_inp[6][4];
        m_tmp[6][5] = (s_valid)? m_inp[6][4] : m_inp[6][5];
        m_tmp[6][6] = (s_valid)? m_inp[6][5] : m_inp[6][6];
