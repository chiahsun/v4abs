...
//             PUNC_PARENTHESIS_LEFT ( ~(PUNC_PARENTHESIS_LEFT | PUNC_PARENTHESIS_RIGHT) | expression) PUNC_PARENTHESIS_RIGHT 
           ...
           // '*' | '/' | '%'
           | expression PUNC_ASTERISK expression
           | expression PUNC_SLASH expression
           | expression PUNC_PERCENT expression
           // '+' | '-' | 
           | expression PUNC_PLUS expression
           | expression PUNC_MINUS expression
           // | '<<' | '>>' 
           | expression PUNC_LESS_THAN PUNC_LESS_THAN expression
           | expression PUNC_GREATER_THAN PUNC_GREATER_THAN expression
           // | '>' | '>=' | '<' | '<='
           | expression PUNC_GREATER_THAN expression
           | expression PUNC_GREATER_THAN PUNC_EQUAL expression
           | expression PUNC_LESS_THAN expression
           | expression PUNC_LESS_THAN PUNC_EQUAL expression
           // | '==' | '!=' 
           | expression PUNC_EQUAL PUNC_EQUAL expression
           | expression PUNC_EXCLAMATION PUNC_EQUAL expression
           // | '===' | '!=='
           | expression PUNC_EQUAL PUNC_EQUAL PUNC_EQUAL expression
           | expression PUNC_EXCLAMATION PUNC_EQUAL PUNC_EQUAL expression
           // | '&' 
           | expression PUNC_AMPERSAND expression
           // | '^' | '^~' | '~^'
           | expression PUNC_CARET expression
           | expression PUNC_CARET PUNC_TILDE expression
           | expression PUNC_TILDE PUNC_CARET expression
           // | '|'
           | expression PUNC_VERTICAL_BAR expression
           // | '&&' 
           | expression PUNC_AMPERSAND PUNC_AMPERSAND expression
           // | '||' 
           | expression PUNC_VERTICAL_BAR PUNC_VERTICAL_BAR expression 
...
constant_expression : PUNC_PARENTHESIS_LEFT constant_expression PUNC_PARENTHESIS_RIGHT 
                    ...
                    // '*' | '/' | '%'
           |  constant_expression PUNC_ASTERISK constant_expression
           | constant_expression PUNC_SLASH constant_expression
           | constant_expression PUNC_PERCENT constant_expression
           // '+' | '-' | 
           | constant_expression PUNC_PLUS constant_expression
           | constant_expression PUNC_MINUS constant_expression
           // | '<<' | '>>' 
           | constant_expression PUNC_LESS_THAN PUNC_LESS_THAN constant_expression
           | constant_expression PUNC_GREATER_THAN PUNC_GREATER_THAN constant_expression
           // | '>' | '>=' | '<' | '<='
           | constant_expression PUNC_GREATER_THAN constant_expression
           | constant_expression PUNC_GREATER_THAN PUNC_EQUAL constant_expression
           | constant_expression PUNC_LESS_THAN constant_expression
           | constant_expression PUNC_LESS_THAN PUNC_EQUAL constant_expression
           // | '==' | '!=' 
           | constant_expression PUNC_EQUAL PUNC_EQUAL constant_expression
           | constant_expression PUNC_EXCLAMATION PUNC_EQUAL constant_expression
           // | '===' | '!=='
           | constant_expression PUNC_EQUAL PUNC_EQUAL PUNC_EQUAL constant_expression
           | constant_expression PUNC_EXCLAMATION PUNC_EQUAL PUNC_EQUAL constant_expression
           // | '&' 
           | constant_expression PUNC_AMPERSAND constant_expression
           // | '^' | '^~' | '~^'
           | constant_expression PUNC_CARET constant_expression
           | constant_expression PUNC_CARET PUNC_TILDE constant_expression
           | constant_expression PUNC_TILDE PUNC_CARET constant_expression
           // | '|'
           | constant_expression PUNC_VERTICAL_BAR constant_expression
           // | '&&' 
           | constant_expression PUNC_AMPERSAND PUNC_AMPERSAND constant_expression
           // | '||' 
           | constant_expression PUNC_VERTICAL_BAR PUNC_VERTICAL_BAR constant_expression 
