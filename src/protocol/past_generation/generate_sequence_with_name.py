...
def get_acceptor_from_file(tcl_filename):
    with open(tcl_filename) as f:
        ...
        if len(content) > 5:
            ...
            print content
            exit(2)
    return sequence_acceptor_with_name(token_name, handle_name, ctor_name, rule_list)


class sequence_acceptor_with_name(generate_sequence_without_name.sequence_acceptor_without_name):
    ...
    def get_acceptor_name(self):
        return "sequence_acceptor_with_name"
