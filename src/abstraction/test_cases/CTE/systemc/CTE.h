...
struct YUV_TO_RGB {
    ...
    bool _v4_prev_busy;
    bool _v4_prev_out_valid;
    sc_uint<24> _v4_prev_rgb_out;
    // Inouts 
    ...
    sc_uint<4> _v4_prev_state;
    sc_uint<4> _v4_prev_state_next;
    sc_uint<8> _v4_prev_reg_U;
    sc_uint<8> _v4_prev_reg_Y1;
    sc_uint<8> _v4_prev_reg_V;
    sc_uint<8> _v4_prev_reg_Y2;
    ...
    sc_uint<8> _v4_prev_reg_U_next;
    sc_uint<8> _v4_prev_reg_Y1_next;
    sc_uint<8> _v4_prev_reg_V_next;
    sc_uint<8> _v4_prev_reg_Y2_next;
    sc_uint<16> _v4_prev_R_ext;
    sc_uint<16> _v4_prev_G_ext;
    sc_uint<16> _v4_prev_B_ext;
    sc_uint<16> _v4_prev_U_ext;
    sc_uint<16> _v4_prev_Y_ext;
    sc_uint<16> _v4_prev_V_ext;
    sc_uint<8> _v4_prev_R_out;
    sc_uint<8> _v4_prev_G_out;
    sc_uint<8> _v4_prev_B_out;
...
//        std::cout << rgb_out << std::endl; 
    ...
    bool _v4_prev_yuv_to_rgb_in_en;
    bool _v4_prev_yuv_to_rgb_busy;
    bool _v4_prev_yuv_to_rgb_out_valid;
