...
calculate = 0;
 ...
 {if (((wri_first || wri_second)?1:(cal_first || cal_second))) {
calculate = 0;
} else
 {calculate = calculate;}}
}
...
void LMFE::func_number_1032() {
    run_one_w = ((s_hei == sc_uint<3>(6)) & (s_wei.and_reduce() == sc_uint<3>(6)));
}

void LMFE::func_number_1033() {
    run_one_h = (((s_hei == sc_uint<3>(6)) & (s_wei.and_reduce() == sc_uint<3>(6))) & (sta_w.and_reduce() == sc_uint<7>(127)));
}

void LMFE::func_number_1034() {
    cal_first = (((sta_h.range(sc_uint<32>(5), sc_uint<32>(0)) == sc_uint<6>(4)) & (sta_w.and_reduce() == sc_uint<7>(0))) & (count.and_reduce() == sc_uint<13>(896)));
}

void LMFE::func_number_1035() {
    cal_second = (((sta_h.range(sc_uint<32>(5), sc_uint<32>(0)) == sc_uint<6>(57)) & (sta_w.and_reduce() == sc_uint<7>(0))) & (count.and_reduce() == sc_uint<13>(7808)));
}
